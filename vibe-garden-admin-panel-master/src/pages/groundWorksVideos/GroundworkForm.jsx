...
const GroundworkForm = ({
  ...
  const [category, setCategory] = useState(freshBloomData?.category?._id);
  ...
  const updateToolVideo = async (e) => {
    ...
    updatedToolVideo.append("category", category);
  ...
  const modalHelper = (
    ...
    >
      <div>
        ...
        <div class="md:grid grid-cols-3 gap-2 overflow-y-auto">
          {videos
          ...
          <div className=" flex justify-around">
            <div className="p-5 w-1/2 flex flex-col justify-around">
              ...
              >
                ...
                {categories
                  ?.filter((category) => category?.categoryType == "groundwork")
                  ?.map((category) => (

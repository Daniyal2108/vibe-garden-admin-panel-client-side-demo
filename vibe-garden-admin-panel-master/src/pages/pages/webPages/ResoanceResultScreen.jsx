      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 space-y-10">
        <div className="m-10 space-y-10">
          <Box
            ...
            text={<p className="mt-4 m-10">Result</p>}
          />
          <Box
            absoluteDiv={
              <div className="w-[70px] h-[50px] bg-[white]  rounded-[25px] absolute -top-6 left-3 flex justify-center items-center ">
          ...
          <Box
            ...
            text={<p className="mt-4 m-10">What fun your top area Resonance</p>}
          />
          <Box
            absoluteDiv={
            ...
            text={
              <p className="mt-4 m-10">And the rest, in Descending order:</p>
            }
          />
        </div>
        <div>

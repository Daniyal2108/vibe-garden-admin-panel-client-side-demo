...
import tools from "./webScreenImages/tools.png";
...
const ToolsScreen = () => {
  ...
  const [toolsPageContent, setToolsPageContent] = useState({
    banner: bannerimg,
    quotation:
  ...
  const toolsTemplateHandler = (e) => {
    const { name, value, files } = e.target;
    setToolsPageContent((prev) => ({
      ...prev,
        ...
        <div className="m-10 space-y-10">
          <div className="w-[95%] h-[200px]  bg-[] border border-[#1C5C2E] rounded-[25px] relative ">
            ...
            <div className="relative h-full">
              <img
                src={
                  typeof toolsPageContent.banner === "string"
                    ? toolsPageContent.banner
                    : // `${ImageUrl}${toolsPageContent.banner}`
                      URL.createObjectURL(toolsPageContent.banner)
                }
                alt="banner img"
          ...
          <Box
            ...
            description={
              <textarea
                type="text"
                value={toolsPageContent.quotation}
          ...
          <Box
            ...
            subHeading={
              <input
                ...
                value={toolsPageContent.bannerHeading}
                onChange={toolsTemplateHandler}
                name="bannerHeading"
              />
            }
          ...
          <Box
            ...
            subHeading={
              <input
                ...
                value={toolsPageContent.headerVideoHeading}
                onChange={toolsTemplateHandler}
            ...
            description={
              <textarea
                type="text"
                value={toolsPageContent.headerVideoDescription}
                onChange={toolsTemplateHandler}

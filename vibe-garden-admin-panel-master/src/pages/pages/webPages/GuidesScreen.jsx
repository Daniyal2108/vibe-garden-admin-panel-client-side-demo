...
const GuidesScreen = () => {
  ...
  const [guidesPageContent, setGuidesPageContent] = useState({
    banner: bannerimg,
    quotation:
    ...
    headerVideoHeading: "Vibe Guides",
    ...
    teacherHeading: "Teachers",
    teacherVideo: "//vjs.zencdn.net/v/oceans.mp4",
    teacherDescription:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium consectetur illum natus facilis debitis beatae nostrum molestiae quia maiores!",
    teacherButtonText: "See All Teachers",

    interestedInVibeGuideHeading: "Interested In Become Vibe Guide?",
    interestedInVibeGuideButton: "Join The Waiting List",
  });

  const guidesTemplateHandler = (e) => {
    const { name, value, files } = e.target;
    setGuidesPageContent((prev) => ({
      ...prev,
        ...
        <div className="m-10 space-y-10">
          <div className="w-[95%] h-[200px]  bg-[] border border-[#1C5C2E] rounded-[25px] relative ">
            ...
            <div className="relative h-full">
              <img
                src={
                  typeof guidesPageContent.banner === "string"
                    ? guidesPageContent.banner
                    : // `${ImageUrl}${guidesPageContent.banner}`
                      URL.createObjectURL(guidesPageContent.banner)
                }
                alt="banner img"
              ...
              <div className="absolute top-2 right-5 w-[100px] h-[30px] bg-[white] rounded-[11px] flex justify-center items-center px-4 py-4">
                ...
                <input
                  ...
                  onChange={guidesTemplateHandler}
                  name="banner"
                />
              </div>
            </div>
          ...
          <Box
            ...
            description={
              <textarea
                type="text"
                value={guidesPageContent.quotation}
          ...
          <Box
            ...
            subHeading={
              <input
                ...
                value={guidesPageContent.bannerHeading}
                onChange={guidesTemplateHandler}
                name="bannerHeading"
              />
            }
          ...
          <Box
            ...
            subHeading={
              <input
                ...
                value={guidesPageContent.headerVideoHeading}
                onChange={guidesTemplateHandler}
            ...
            description={
              <textarea
                type="text"
                value={guidesPageContent.headerVideoDescription}
                onChange={guidesTemplateHandler}
          ...
          <Box
            ...
            subHeading={
              <input
                type="text"
                className="mt-6 font-semibold text-[14px] ml-5 w-[90%] outline-none"
                value={guidesPageContent.teacherHeading}
                onChange={guidesTemplateHandler}
                name="teacherHeading"
              />
            }
            ...
            description={
              <textarea
                type="text"
                value={guidesPageContent.teacherDescription}
                onChange={guidesTemplateHandler}
            ...
            button={
              <input
                value={guidesPageContent.teacherButtonText}
                onChange={guidesTemplateHandler}
                name="teacherButtonText"
          ...
          <Box
            ...
            subHeading={
              <input
                type="text"
                className="mt-6 font-semibold text-[14px] ml-5 w-[90%] outline-none"
                value={guidesPageContent.interestedInVibeGuideHeading}
                onChange={guidesTemplateHandler}
                name="interestedInVibeGuideHeading"
              />
            }
            line={<div className="border-t border-[#1C5C2E] mt-[15px] "></div>}
            button={
              <input
                value={guidesPageContent.interestedInVibeGuideButton}
                onChange={guidesTemplateHandler}
                name="interestedInVibeGuideButton"
                className="p-3 hover:drop-shadow-xl flex items-center gap-2 justify-center text-center border border-solid border-green-800 text-[#979B9F] rounded-full w-[150] h-[45] outline-none"
              />
            }
          />

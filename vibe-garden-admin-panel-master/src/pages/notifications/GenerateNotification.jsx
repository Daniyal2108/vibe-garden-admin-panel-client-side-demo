    ...
    <>
      <div className="bg-[white] shadow-lg shadow-[#00000029]-500/50 w-[95%] h-[300px] rounded-[20px] m-10 overflow-y-auto ">
        <div className="flex flex-row justify-between px-4 py-3">
          <div className="m-2 ">
            <h1
              className="font-medium text-[#1C5C2E] text-[24px] px-5 py-"
              style={{ marginTop: 20 }}
            >
            ...
            <div className="mt-5 px-5">
              <label class="inline-flex items-center">
                <input
                  type="radio"
                  class="form-radio border-2 text-[#1C5C2E]"
                  name="radio-colors"
                  value="email"
          ...
          <div className="bg-[#FF4053] flex flex-row justify-center items-center w-[300px] h-[100px] rounded-[20px] mt-5">
            ...
            <p className="text-white text-[14px] ml-5">
              Mobile Push Notification Users <br />
              345 Users
            </p>
          </div>
        </div>
      ...
      <div className="m-10">
        <div className="flex flex-row">
          ...
          <p className="text-[16px] ml-5 mt-2 font-semibold">
        ...
        <div className="grid grid-cols-3 gap-4 mt-5">
          <div className="border rounded-[20px] w-[300px] h-[120px]  flex flex-row justify-center items-center">
            <p className="h-[56px] w-[56px] bg-[#C5C5C5] rounded-md"></p>
            <p className=" text-[14px] ml-5 font-semibold">
              Lorem ipsum dolor sit.
              <br />
              <span className="font-light text-gray-600">
                09:00-AM - Nov-21-2022
              </span>
            </p>
            <div className="w-[25px] h-[25px] text-[red] flex flex-row justify-center items-center ml-5 mb-20">
              <GiCancel />
            </div>
          </div>
        </div>

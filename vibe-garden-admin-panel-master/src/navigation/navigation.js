...
import UserTypes from "../pages/notifications/UserTypes";
import GeneratePushNotification from "../pages/notifications/pushNotification/GeneratePushNotification";
...
const ToolsScreen = React.lazy(() =>
  import("../pages/pages/webPages/ToolsScreen")
);
...
const HomePageLoggedIn = React.lazy(() =>
  import("../pages/pages/webPages/HomePageLoggedIn")
);
